...
open class SMSegment: UIView {
	...
	private func addUIElementsToView() {
        ...
        self.imageView.contentMode = self.appearance?.segmentImageScale ?? UIView.ContentMode.scaleAspectFit 
	...
	open override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
		if self.isSelected == false || self.appearance?.segmentMultiSelect ?? false {
